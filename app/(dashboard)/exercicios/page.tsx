...
import { getPracticeExercises, getExerciseCompletions } from "@/lib/data/queries";
...
export default async function ExerciciosPage() {
  const [practice, serverDone] = await Promise.all([
  ...
  return (
    <div>
      ...
      <PracticeExercisesView exercises={practice} serverDone={serverDone} />
    </div>
  );
}
