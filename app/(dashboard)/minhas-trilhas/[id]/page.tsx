        ...
        {trilhaUnlocked && (
          <div className="mt-4">
            ...
            <div className="h-2 w-full overflow-hidden rounded-full bg-muted">
              <div className="h-full rounded-full bg-gradient-to-r from-primary to-secondary" style={{ width: `${overall}%` }} />
            </div>
          </div>
        )}
      </div>
                  ...
                  <div key={m.slug} className="card flex items-center gap-4 p-4">
                    <span
                      className={cn(
                        ...
                        done ? "bg-secondary/15 text-secondary" : "bg-surface-2 text-text-secondary",
                      )}
                    >
