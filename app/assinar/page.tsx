...
export default async function AssinarPage({
  ...
  searchParams: Promise<{ checkout?: string; upgrade?: string; trial?: string; ciclo?: string }>;
}) {
  ...
  const { checkout, upgrade, trial, ciclo } = await searchParams;
    ...
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <main className="container relative py-10 lg:py-14">
        ...
        <div className="mx-auto mt-10 max-w-5xl">
          <PlanSelector trialDays={STRIPE_TRIAL_DAYS} currentTier={tier} defaultAnnual={ciclo === "anual"} />
        </div>
