  ...
  return (
    <div className="space-y-3">
      ...
      <label className="flex items-center gap-2 text-sm">
        <input type="checkbox" checked={notify} onChange={(e) => setNotify(e.target.checked)} className="h-4 w-4 accent-[rgb(var(--primary))]" />
        Avisar todos os usuários sobre esta nova versão (notificação + popup)
      </label>
      <button
