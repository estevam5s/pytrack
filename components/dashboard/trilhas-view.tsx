...
import { TrilhaListProgress } from "@/components/dashboard/trilha-progress";
...
export interface TrilhaStat {
  ...
  hours: number;
  progress: number;
  moduleSlugs?: { slug: string; total: number; serverPct: number }[];
}
        ...
        {list.map((t) => {
          ...
          return (
            ...
            >
              ...
              {unlocked && (
                <TrilhaListProgress modules={s.moduleSlugs ?? []} serverFallback={s.progress} />
              )}
