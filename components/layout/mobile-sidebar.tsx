...
import { SidebarContent, type SidebarProfile } from "./sidebar";
      ...
      {mobileSidebarOpen && (
        <div className="lg:hidden">
          ...
          >
            ...
            <SidebarContent tier={tier} notif={notif} notifCount={notifCount} isAdmin={isAdmin} profile={profile} onNavigate={() => setMobileSidebar(false)} />
          </motion.aside>
        </div>
      )}
    </AnimatePresence>
